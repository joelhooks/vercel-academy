...
>(({ className, children, ...props }, ref) => (
	...
	>
		{children}
		<ChevronDownSmall
			className="relative top-px text-current size-3.5 group-data-[state=open]:rotate-180"
			aria-hidden="true"
		/>
...
>(({ className, ...props }, ref) => (
	<NavigationMenuPrimitive.Indicator
		...
		{...props}
	>
		<div className="relative top-[6.5px] size-4 rotate-45 bg-white border border-r-0 border-b-0 rounded-tl-sm border-zinc-200" />
	</NavigationMenuPrimitive.Indicator>
))
	...
	<li>
		<NavigationMenuLink onSelect={onSelect} asChild>
			...
			>
				...
				{description && (
					<p className="text-[0.8rem] leading-snug line-clamp-2 text-zinc-500">{description}</p>
				)}
			</Link>
		</NavigationMenuLink>
	</li>
